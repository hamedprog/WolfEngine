...
// modified by Pooya Eimandar in order to work with async asio
    ...
    namespace fibers
    {
        namespace asio
        {
            namespace detail
            {
                ...
                {
                public:
                    yield_handler_base(yield_t const &y) : // capture the context* associated with the running fiber
                    ...
                    {
                        assert(ycomp_ && "Must inject yield_completion* before calling yield_handler_base::operator()()");
                        assert(yt_.ec_ && "Must inject boost::system::error_code* before calling yield_handler_base::operator()()");
                ...
                public:
                    ...
                    {
                        assert(value_ && "Must inject value ptr before caling yield_handler<T>::operator()()");
            ...
            class async_result<boost::fibers::asio::yield_t, ReturnType(boost::system::error_code, T)> : public boost::fibers::asio::detail::async_result_base
            {
            public:
                ...
                explicit async_result(boost::fibers::asio::detail::yield_handler<T> &h) : boost::fibers::asio::detail::async_result_base{h}
                {
            ...
            template <>
            class async_result<boost::fibers::asio::yield_t, void(boost::system::error_code)> : public boost::fibers::asio::detail::async_result_base
            {
            public:
                using return_type = void;
                using completion_handler_type = fibers::asio::detail::yield_handler<void>;

                explicit async_result(boost::fibers::asio::detail::yield_handler<void> &h) : boost::fibers::asio::detail::async_result_base{h}
                {
                }
            };
            //]
