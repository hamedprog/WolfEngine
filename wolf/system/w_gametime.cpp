...
[[nodiscard]] auto w_gametime::get_fps() const noexcept { return this->_fps; }

[[nodiscard]] auto w_gametime::get_fixed_time_step() const noexcept {
  return this->_fixed_time_step;
}

void w_gametime::set_fixed_time_step(bool p_value) {
  this->_fixed_time_step = p_value;
}

void w_gametime::set_target_elapsed_secs(double p_value) {
